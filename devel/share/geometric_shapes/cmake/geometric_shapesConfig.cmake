...
if("TRUE" STREQUAL "TRUE")
  set(geometric_shapes_SOURCE_PREFIX /ws_moveit/src/geometric_shapes)
  set(geometric_shapes_DEVEL_PREFIX /ws_moveit/devel)
  ...
  set(geometric_shapes_INSTALL_PREFIX /ws_moveit/install)
...
if(NOT "/ws_moveit/src/geometric_shapes/include;/usr/include/eigen3;/opt/ros/melodic/include;/usr/include " STREQUAL " ")
  set(geometric_shapes_INCLUDE_DIRS "")
  set(_include_dirs "/ws_moveit/src/geometric_shapes/include;/usr/include/eigen3;/opt/ros/melodic/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'geometric_shapes' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/ws_moveit/src/geometric_shapes/${idir}'.  ${_report}")
    endif()
