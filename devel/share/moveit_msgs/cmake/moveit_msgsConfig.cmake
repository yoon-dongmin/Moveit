...
if("TRUE" STREQUAL "TRUE")
  set(moveit_msgs_SOURCE_PREFIX /ws_moveit/src/moveit_msgs)
  set(moveit_msgs_DEVEL_PREFIX /ws_moveit/devel)
  ...
  set(moveit_msgs_INSTALL_PREFIX /ws_moveit/install)
...
if(NOT "/ws_moveit/devel/include " STREQUAL " ")
  set(moveit_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/ws_moveit/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/ws_moveit/src/moveit_msgs/${idir}'.  ${_report}")
    endif()
